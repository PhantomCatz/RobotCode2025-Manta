...
public class SubystemVisualizer {
    ...
    public static final Translation2d outtakeOrigin2d =
            superstructureOrigin2d.plus(
                    new Translation2d(outtakeToBottom + stageThickness * 2, elevatorAngle));
    public static final Translation3d outtakeOrigin3d =
            new Translation3d(outtakeOrigin2d.getX(), 0.0, outtakeOrigin2d.getY());
    ...
    public void update(double elevatorHeightMeters, Rotation2d giantPivotFinalAngle, Rotation2d wristAngle) {
        ...
        final double heightFromBottom =
                elevatorHeightMeters + outtakeToBottom + outtakeToTop + stageThickness * 2.0;
        final double firstStageHeight =
                Math.max(
                        heightFromBottom - SubystemVisualizer.firstStageHeight - stageThickness,
                        stageThickness);
