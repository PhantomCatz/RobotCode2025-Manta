...
public abstract class FlywheelMotorSubsystem extends GenericMotorSubsystem {
	...
	public FlywheelMotorSubsystem(GenericMotorIO io, String name, double epsilonThreshold, ServoHomingConfig homingConfig) {
		super(io, name);
		this.io = io;
		this.name = name;
	...
	public abstract void onFlywheelUpdate();
