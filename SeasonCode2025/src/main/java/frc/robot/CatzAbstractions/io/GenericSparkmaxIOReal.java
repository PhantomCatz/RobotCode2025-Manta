...
//      */
//     public GenericSparkmaxIOReal(SparkMax motor, double FL, Gains s0g, IdleMode motorMode) {
...
//      * @param motorMode motor mode
//      */
//     public GenericSparkmaxIOReal(SparkMax leader, ArrayList<SparkMax> followerMotor, double FL, Gains s0g, IdleMode motorMode) {
...
//      * @param s0g slot 0 gains
//      */
//     public GenericSparkmaxIOReal(SparkMax motor, double FL, Gains s0g) {
...
//      * @param s0g slot 0 gains
//      */
//     public GenericSparkmaxIOReal(SparkMax leader, ArrayList<SparkMax> followerMotor, double FL, Gains s0g) {
//         this(leader, FL, s0g);
...
//         inputs.absoluteEncoderPosition = leaderSpark.getAbsoluteEncoder().getPosition(); //TODO does this need to be multiplied by final ratio?
//         inputs.velocityRPS = leaderSpark.getAbsoluteEncoder().getVelocity();
//         inputs.appliedVolts[0] = leaderSpark.getAppliedOutput();
//         inputs.supplyCurrentAmps[0] = leaderSpark.getOutputCurrent();
//         inputs.torqueCurrentAmps[0] = 2; //TODO I have literally no idea
